function [RI_registered, shift_vector, tform] = RegisterRI_Gel(TFM,RIRef, RIMoving, z_interface_plot,RI_bg,Mask_RI_2D)
...
% 1. XY first
    ImRef_XY = max(RIRef(:,:,floor(end/9*5):end) .* reshape(z_interface_plot,1,1,[]),[],3) .* Mask_RI_2D_shrink;
